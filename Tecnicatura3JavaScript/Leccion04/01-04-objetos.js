...
let persona = {
    ...
    get nombreEdad(){ // Añadiendo metodo get en nuestra variable
...
let persona2 = new Object(); // Crea objeto y reserva memoria
persona2.name = 'juan'; //Creamos sus propiedades
persona2.direccion = 'salada 14';
persona2.telefono = '116641516';

console.log(persona2.name);
console.log(persona['apellido']); //Usamos los obj como si fuesen arrays

//FOR IN: como actuan como arrays podemos usar ciclos for, pero modificado
...
persona.segundonombre = "Marcos"; // Agregamos
console.log(persona);
...
let padre = new Persona3('Leo', 'Lopez', 'lopezleo@mail.com')
...
console.log(persona4.nombreTituloTelefono('Licenciado', '116641515'));
console.log(persona4.nombreTituloTelefono.call(persona5, 'Ingeniero', '1156623365'))
